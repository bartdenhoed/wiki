...
Appearance > General > Theme: Regular > Minimal
Appearance > Tabs > Show tab bar even when there is only one tab: On

Profiles > Window > Transparency: 10%

Advanced > General > Height of top and bottom margins in terminal panes: 15
Advanced > General > Width of left and right margins in terminal panes: 20
...
# TODO
MacPass: A KeePass client for macOS.
Bartender 3: Organize your menu bar apps.
Noti Native macOS notifications from Pushbullet
...
RansomWhere? Let's try to generically thwart OS X ransomware via math!
